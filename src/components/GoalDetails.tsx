...
export const GoalDetails: React.FC<GoalDetailsProps> = ({ scorer, assists, score, time, shotType, special, team }) => {
  const assist1 = assists[0]
  const assist2 = assists[1]
  return (

    <div className="w-[250px] h-[100px] border border-white rounded-lg overflow-y-hidden">
